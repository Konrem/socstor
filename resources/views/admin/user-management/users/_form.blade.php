...
<div class="form-group">
    ...
    <input type="text" class="form-control" name="name" id="name"
           placeholder="Введіть ім'я" value="@if( old('name') ) {{old('name')}}@else{{$user->name ?? '' }}@endif" maxlength="255" onkeyup="inputValidation(this.value, 'name_val', '255')">
...
<div class="form-group">
    ...
    <input type="text" class="form-control" name="email" id="email"
           placeholder="Введіть email" value="@if( old('email') ) {{ old('email')}}@else{{$user->email ?? '' }}@endif" maxlength="255" onkeyup="inputValidation(this.value, 'email_val', '255')">
